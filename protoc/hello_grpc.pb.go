...
type ExampleClient interface {
	MemoryRequirments(ctx context.Context, in *RequirmentsRequest, opts ...grpc.CallOption) (*SupplyResponse, error)
...
func (c *exampleClient) MemoryRequirments(ctx context.Context, in *RequirmentsRequest, opts ...grpc.CallOption) (*SupplyResponse, error) {
	out := new(SupplyResponse)
	err := c.cc.Invoke(ctx, "/Example/MemoryRequirments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	MemoryRequirments(context.Context, *RequirmentsRequest) (*SupplyResponse, error)
...
func (UnimplementedExampleServer) MemoryRequirments(context.Context, *RequirmentsRequest) (*SupplyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MemoryRequirments not implemented")
}
...
func _Example_MemoryRequirments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequirmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).MemoryRequirments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Example/MemoryRequirments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).MemoryRequirments(ctx, req.(*RequirmentsRequest))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MemoryRequirments",
			Handler:    _Example_MemoryRequirments_Handler,
		},
		{
